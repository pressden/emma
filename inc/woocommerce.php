...
if ( ! function_exists( 'emma_woocommerce_wrapper_before' ) ) {
	/**
	 * Before Content.
	 *
...
add_action( 'woocommerce_before_main_content', 'emma_woocommerce_wrapper_before' );

if ( ! function_exists( 'emma_woocommerce_wrapper_after' ) ) {
	/**
	 * After Content.
	 *
...
add_action( 'woocommerce_after_main_content', 'emma_woocommerce_wrapper_after' );
