...
function emma_scripts() {
	wp_enqueue_style( 'emma', get_stylesheet_directory_uri() . '/dist/theme.css', null, wp_get_theme()->get( 'Version' ) );

	wp_enqueue_script( 'emma', get_stylesheet_directory_uri() . '/dist/theme.js', null, wp_get_theme()->get( 'Version' ), true );
